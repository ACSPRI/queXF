...
function vqi($vid,$qid)
{
	...
	$sql = "INSERT INTO
		supervisorquestionnaire (vid,qid)
		VALUES('$vid','$qid')";
...
xhtml_head(T_("Assign supervisor to questionnaire"),false,array("../css/table.css"));

print "<p>" . T_("If supervisor(s) is/are assigned to a questionnaire - operators will be able to assign their current form to a supervisor to verify and move on.") . "</p>";
...
print "</table><p><input type=\"submit\" name=\"submit\" value=\"" .T_("Assign supervisor to questionnaire") . "\"/></p></form>";
